...
public class CategoryGrinder implements IRecipeCategory<GrinderRecipe> {
	...
	public CategoryGrinder(IGuiHelper helperIn) {
		...
		this.background = this.helper.createDrawable(PROCESSING.GRINDER_LOC_GUI_JEI, 0, 0, 120, 68);
	...
	public IDrawable getIcon() {
		return this.helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(ModRegistrationManager.BLOCK_GRINDER));
	}
