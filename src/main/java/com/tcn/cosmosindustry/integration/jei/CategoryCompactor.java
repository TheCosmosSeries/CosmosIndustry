...
public class CategoryCompactor implements IRecipeCategory<CompactorRecipe> {
	...
	public CategoryCompactor(IGuiHelper helperIn) {
		...
		this.background = this.helper.createDrawable(PROCESSING.COMPACTOR_LOC_GUI_JEI, 0, 0, 120, 68);

		IDrawableStatic process_draw = helper.createDrawable(PROCESSING.COMPACTOR_LOC_GUI, 176, 0, 16, 16);
	...
	public IDrawable getIcon() {
		return this.helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(ModRegistrationManager.BLOCK_COMPACTOR));
	}
