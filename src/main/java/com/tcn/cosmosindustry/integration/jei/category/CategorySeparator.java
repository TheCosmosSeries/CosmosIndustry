...
public class CategorySeparator implements IRecipeCategory<SeparatorRecipe> {
	...
	public CategorySeparator(IGuiHelper helperIn) {
		...
		this.background = this.helper.createDrawable(IndustryReference.Resource.Processing.Gui.SEPARATOR_JEI, 0, 0, 120, 68);

		IDrawableStatic process_draw = helper.createDrawable(IndustryReference.Resource.Processing.Gui.SEPARATOR_LIGHT, 176, 0, 16, 16);
	...
	public IDrawable getIcon() {
		return this.helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(IndustryRegistrationManager.BLOCK_SEPARATOR));
	}
