...
abstract public class AbstractContainerCapacitor extends CosmosContainerMenuBlockEntity {

	public AbstractContainerCapacitor(MenuType<?> typeIn, int indexIn, Inventory playerInventoryIn, FriendlyByteBuf extraData) {
