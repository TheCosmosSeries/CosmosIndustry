...
public class SeparatorRecipe implements Recipe<RecipeInput> {
	...
	public ItemStack getToastSymbol() {
		return new ItemStack(ModRegistrationManager.BLOCK_SEPARATOR.get());
	}

	@Override
	public RecipeSerializer<?> getSerializer() {
		return ModRecipeManager.RECIPE_SERIALIZER_SEPARATING.get();
	}

	@Override
	public RecipeType<?> getType() {
		return ModRecipeManager.RECIPE_TYPE_SEPARATING.get();
	}
