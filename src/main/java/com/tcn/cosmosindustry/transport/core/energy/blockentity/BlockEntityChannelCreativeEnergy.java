...
public class BlockEntityChannelCreativeEnergy extends AbstractBlockEntityEnergyChannel {
	...
	public BlockEntityChannelCreativeEnergy(BlockPos posIn, BlockState stateIn) {
		super(ModRegistrationManager.BLOCK_ENTITY_TYPE_CHANNEL_ENERGY_CREATIVE.get(), posIn, stateIn, TRANSPORT.ENERGY_CREATIVE, EnumIndustryTier.CREATIVE, EnumRenderType.OPAQUE);
	}
}