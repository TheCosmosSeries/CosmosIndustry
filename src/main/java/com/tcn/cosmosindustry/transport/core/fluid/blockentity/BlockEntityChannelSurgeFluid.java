...
public class BlockEntityChannelSurgeFluid extends AbstractBlockEntityFluidChannel {
	...
	public BlockEntityChannelSurgeFluid(BlockPos posIn, BlockState stateIn) {
		super(IndustryRegistrationManager.BLOCK_ENTITY_TYPE_CHANNEL_FLUID_SURGE.get(), posIn, stateIn, IndustryReference.Resource.Transport.FLUID_SURGE, EnumIndustryTier.SURGE);
	}
}